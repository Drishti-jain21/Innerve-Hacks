...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const submitDetailsForm = document.querySelector("#submitDetails");
    ...
    document.querySelector("#linkCreateAccount").addEventListener("click", e => {
        ...
        submitDetailsForm.classList.add("form--hidden");
    });
    ...
    document.querySelector("#linksubmitDetails").addEventListener("click", e => {
        e.preventDefault();
        resetPasswordForm.classList.add("form--hidden");
        loginForm.classList.add("form--hidden");
        createAccountForm.classList.add("form--hidden");
        submitDetailsForm.classList.remove("form--hidden");
    });
